...
interface WasmModule {
  ...
  _api_thrust(): number;
  _api_lift(): number;
  _api_autopilot_heading_target(): number;
  _api_autopilot_pitch_target(): number;
  _api_autopilot_bank_target(): number;
  _api_autopilot_altitude_target(): number;
  _api_autopilot_vertical_speed_target(): number;
  _api_autopilot_ias_speed_target(): number;
  _api_autopilot_true_speed_target(): number;
  ...
  _api_autopilot_heading_hold(): number;
  _api_autopilot_pitch_hold(): number;
  ...
  _api_autopilot_altitude_hold(): number;
  _api_autopilot_vertical_speed_hold(): number;
...
interface EmbindModule {
  ...
  api_set_atmosphere_wind_speed_knots(_0: number): void;
  api_set_atmosphere_wind_direction_deg(_0: number): void;
  ...
  api_set_motion_cues(_0: boolean): boolean;
  api_set_simulation_reset(): void;
  api_set_simulation_speed(_0: number): void;
  api_set_autopilot_heading_hold(_0: boolean): void;
  api_set_autopilot_mach_speed_hold(_0: boolean): void;
  api_set_autopilot_ias_speed_hold(_0: boolean): void;
  api_set_autopilot_true_speed_hold(_0: boolean): void;
  api_set_autopilot_altitude_target(_0: number): void;
  api_set_autopilot_bank_target(_0: number): void;
  api_set_autopilot_heading_target(_0: number): void;
  api_set_autopilot_pitch_target(_0: number): void;
  api_set_autopilot_true_speed_target(_0: number): void;
  api_set_autopilot_ias_speed_target(_0: number): void;
  api_set_autopilot_mach_speed_target(_0: number): void;
  api_set_autopilot_vertical_speed_target(_0: number): void;
  api_set_landing_gear_selector_position(_0: number): boolean;
  api_set_flaps_selector_position(_0: number): boolean;
  api_set_autopilot_vertical_speed_hold(_0: boolean): void;
  ...
  api_set_latitude(_0: number): void;
  api_set_longitude(_0: number): void;
