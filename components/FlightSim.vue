      ...
      return [
        {
          ...
          setter_model: Number(this.api_target_heading_deg).toFixed(0),
          unit: '°',
          min: 0,
          max: 359,
          step: 1.0,
        },
        {
          ...
          setter_model: Number(this.api_target_bank_deg).toFixed(0),
          unit: '°',
          min: -50,
          max: 50,
          step: 1.0,
        },
        {
          ...
          setter_model: Number(this.api_target_altitude).toFixed(0),
          unit: 'ft',
          min: 0,
          max: 50000,
          step: 100.0,
        },
        {
          ...
          setter_model: Number(this.api_target_vertical_speed).toFixed(0),
          unit: 'fpm',
          min: -6000,
          max: 6000,
          step: 100,
        },
        {
          ...
          setter_model: Number(this.api_target_speed).toFixed(0),
          unit: 'kt',
          min: 0,
          max: 350,
          step: 1,
        },
        {
          ...
          setter_model: Number(this.api_target_mach_speed).toFixed(2),
          unit: 'M',
          min: 0,
          max: 1.5,
          step: 0.01,
        ...
        Aircraft: [
          {
            ...
            value: Number(this.api_thrust_to_weight).toFixed(2),
        ...
        Aerodynamics: [
          {
            ...
            value: Number(this.api_cl0).toFixed(2),
          ...
          },
          {
            ...
            value: Number(this.api_cdo).toFixed(4),
