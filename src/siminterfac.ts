...
export const simulationDataDisplay: SimulationDataDisplay = {
  ...
  api_rudder_position: { api: "api_rudder_position", label: "Rudder", visible: false },
  api_aileron_trim_position: { api: "api_aileron_trim_position", label: "Aileron Trim", visible: false },
  api_elevator_trim_position: { api: "api_elevator_trim_position", label: "Elevator Trim", visible: false },
  api_rudder_trim_position: { api: "api_rudder_trim_position", label: "Rudder Trim", visible: false },
