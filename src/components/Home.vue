  ...
  <div class="relative h-screen flex items-center justify-center bg-custom-dark text-custom-gray overflow-hidden">
    ...
    <div class="relative text-center px-6 w-full max-w-4xl mx-auto">
      ...
      <p class="mt-2 text-lg md:text-2xl font-light relative z-10 min-h-[2rem]">
        <span v-for="(word, index) in words" :key="index" class="inline-block opacity-0 animate-fade-in"
      ...
      <div class="flex flex-col justify-center items-center border-gray-500 py-2 mt-4">
        ...
        <div class="flex flex-col md:flex-row items-center gap-3 w-full justify-center">
          <input
            ...
            type="text" placeholder="Session ID" :value="isFocused ? roomId : `Session ID: ${roomId}`"
        ...
        <div
          ...
          <p>
            ...
            educational purposes only. It does not represent real-world flight
            conditions and must not be used for actual aviation training,
            navigation, or operational decision-making.
          </p>

          <p class="mt-2">
            By using this application, you acknowledge that the developers and
            contributors accept no liability for any damages, losses, injuries, or
